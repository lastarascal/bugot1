...
<head>
	...
	<title>DMCA Notice<?=$sitename;?></title>
...
<li id="menu-item-21431" class="menu-item menu-item-type-taxonomy menu-item-object-category menu-item-21431 Sitemap"><a href="<?=$siteurl;?>/xml-sitemap-index.xml">&nbsp;Sitemap Index</a></li>
	...
	<div class="row">
		...
		<p><?=strtoupper($sitename);?> respects the intellectual property of others. <?=strtoupper($sitename);?> takes matters of Intellectual Property very seriously and is committed to meeting the needs of content owners while helping them manage publication of their content online.</p>
			<p>It should be noted that <?=strtoupper($sitename);?> is a simple search engine of ebooks available at a wide variety of third party websites.</p>
			...
			<p></p>
			<p><b>Contact by Email: <a href="mailto:<?=$email;?>"><?=$email;?></a></b></p>
			<p>WE CAUTION YOU THAT UNDER FEDERAL LAW, IF YOU KNOWINGLY MISREPRESENT THAT ONLINE MATERIAL IS INFRINGING, YOU MAY BE SUBJECT TO HEAVY CIVIL PENALTIES. THESE INCLUDE MONETARY DAMAGES, COURT COSTS, AND ATTORNEYS&acute; FEES INCURRED BY US, BY ANY COPYRIGHT OWNER, OR BY ANY COPYRIGHT OWNER&acute;S LICENSEE THAT IS INJURED AS A RESULT OF OUR RELYING UPON YOUR MISREPRESENTATION. YOU MAY ALSO BE SUBJECT TO CRIMINAL PROSECUTION FOR PERJURY.</p>
